(() => {
    ...
    function initSliders() {
        if (document.querySelector(".responses__slider")) new core(".responses__slider", {
    ...
    function modal(triggerSelector, modalSelector) {
        ...
        document.addEventListener("keydown", (e => {
            if ("Escape" === e.code && modal.classList.contains("show")) closeModal(modalSelector);
        }));
    }
    modal(".play-js", ".hero__video");
    modal("[data-modal]", "[data-modal-o]");
})();